...
const ResponsiveNavLink = ({ active = false, children, ...props }: LinkProps & { active?: boolean, children: React.ReactNode }) => (
    <Link
        {...props}
...
export const ResponsiveNavButton = ({ children, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement> & { children: React.ReactNode }) => (
    <button
